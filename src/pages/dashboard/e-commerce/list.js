...
export default function EcommerceProductListPage() {
  ...
  const handleEditRow = (id) => {
    push(PATH_PAGE.eCommerce.edit(paramCase(id)));
  };

  const handleViewRow = (id) => {
    push(PATH_PAGE.eCommerce.view(paramCase(id)));
  };
    ...
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            { name: 'Dashboard', href: PATH_PAGE.home.root },
            {
              name: 'E-Commerce',
              href: PATH_PAGE.eCommerce.root,
            },
            { name: 'List' },
          ]}
          action={
